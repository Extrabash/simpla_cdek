...
class CartView extends View
{
  ...
  public function __construct()
  {
    ...
    if(isset($_POST['checkout']))
    {
      ...
      // Часть с доставкой CDEK, id из админки
			if($delivery->id ==13)
			{
				$delivery->price = $this->request->post('del_price');
				
				$this->orders->update_order($order->id, array('delivery_price'=>$delivery->price, 'separate_delivery'=>$delivery->separate_payment, 'delivery_info'=>'До двери' ));
			}
