...
$cache_days = 30;
$delivery = $simpla->delivery->get_delivery(13);
...
if ($track = $simpla->request->get('track', 'string')) {
    ...
    $simpla->CDEK->setAuth('4baoXmCimjbBye28WC5kiJIkdslc3Tmm', 'KXi8sKwP034yIWfgtYv2RhfKkuxn5DzB');
...
if ($code = $simpla->request->get('code')) {
    ...
    if (!empty($cityCode)) {
        //Авторизация. Для получения логина/пароля (в т.ч. тестового) обратитесь к разработчикам СДЭК -->
        $simpla->CDEK->setAuth('4baoXmCimjbBye28WC5kiJIkdslc3Tmm', 'KXi8sKwP034yIWfgtYv2RhfKkuxn5DzB'); // рабочие ключи
